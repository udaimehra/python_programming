...
#similar to http://www.py4e.com/code3/xml3.py. 
...
#Actual data: http://py4e-data.dr-chuck.net/comments_2141809.xml (Sum ends with 42)
...
if len(url) < 1 : 
    ...
    url = 'http://py4e-data.dr-chuck.net/comments_2141809.xml' 
    #(For above URL Sum ends with 42)
